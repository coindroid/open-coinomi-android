...
import com.coinomi.core.coins.%COIN_NAME_FIRST_CHAR_UPPERCASE%Main;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/%COIN_NAME%/%COIN_NAME%/releases";

    public static final String VERSION_URL = "%COIN_WEBSITE%/version";
    public static final String PARTNERS_URI = "%COIN_WEBSITE%/partner.json";
    public static final String SUPPORT_EMAIL = "%SUPPORT_EMAIL%";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(%COIN_NAME_FIRST_CHAR_UPPERCASE%Main.get(), new ServerAddress("%ELECTRUM_SERVER%", %ELECTRUM_PORT%),
                    new ServerAddress("%ELECTRUM_SERVER%", %ELECTRUM_PORT%))
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.%COIN_FULLNAME_UPPERCASE%_MAIN.getCoinType(), R.drawable.%ICONSET%);


        COINS_BLOCK_EXPLORERS = new HashMap<>();
        COINS_BLOCK_EXPLORERS.put(CoinID.%COIN_FULLNAME_UPPERCASE%_MAIN.getCoinType(), "%EXPLORER_LINK%");
    }
    ...
    public static final List<CoinType> SUPPORTED_COINS = ImmutableList.of(
            %COIN_NAME_FIRST_CHAR_UPPERCASE%Main.get()
